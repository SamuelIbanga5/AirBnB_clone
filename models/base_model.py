...
class BaseModel:
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            ...
            instance is created and it will be updated everytime project is
            changed.
        """
        if len(kwargs) == 0:
    ...
    def __str__(self):
        """__str__ method that prints a string representation
        of BaseModel class
    ...
    def to_dict(self):
        """to_dict method returns a dictionary containing all keys/values
